                    ...
                    <form action="AdminModif" method="POST">
                        ...
                        <div class="form-row col col-12"> 
                            <div class="form-row col col-6">
                                <button type="submit" class="btn btn-outline-success justify-content-arround">Valider la modification</button>
                            </div>
                            <div class="form-row col col-6">
                                <a href="Home" <button type="button" class="btn btn-outline-danger justify-content-arround">Retour au menu</button></a>
                            </div>
                        </div>
                    </form>
                </div>    
